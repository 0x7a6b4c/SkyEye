managed_policies = {
  ...
  "S15_AMP_PolicyD" = {
    description = "DeleteConnection & GetCodeGuruFreeTrialSummary"
    policy = {
      Version = "2012-10-17"
      Statement = [{
        Effect = "Allow"
  ...
  "S15_AMP_PolicyX" = {
    description = "DeleteAccelerator & BatchGetApplications"
    policy = {
      Version = "2012-10-17"
      Statement = [{
        Effect = "Allow"
  ...
  "S15_AMP_PolicyZ" = {
    description = "IoTAnalytics DeleteDataset & CreateLibraryItemReview"
    policy = {
      Version = "2012-10-17"
      Statement = [{
        Effect = "Allow"
