managed_policies = {
  ...
  "S16_AMP_PolicyD" = {
    description = "Codecatalyst DeleteConnection & CodeGuru GetCodeGuruFreeTrialSummary"
    policy = {
      Version   = "2012-10-17"
      Statement = [{
        Effect   = "Allow"
  ...
  "S16_AMP_PolicyF" = {
    description = "IAM ListAttachedRolePolicies, GetGroupPolicy, ListGroupPolicies"
    policy = {
      Version   = "2012-10-17"
      Statement = [{
        Effect   = "Allow"
  ...
  "S16_UserC_RoleC" = {
    ...
    inline_policies = {
      "S16_IP_UserC_RoleC" = {
        ...
        Statement = [{
          Effect   = "Allow"
          Action   = ["s3-object-lambda:GetObjectAcl","iam:GetPolicyVersion"]
          Resource = "*"
        }]
      }
    }
