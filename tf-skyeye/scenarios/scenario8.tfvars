managed_policies = {
  ...
  "S8_AMP_PolicyG" = {
    description = "ListPolicyVersions, ListRolePolicies, GetPolicyVersion"
    policy = {
      Version = "2012-10-17"
      Statement = [{
        Effect = "Allow"
...
users = {
  "S8_UserA" = {
    ...
    managed_policies  = ["S8_AMP_PolicyA", "S8_AMP_PolicyB"]
    groups            = ["S8_GroupA"]
...
groups = {
  "S8_GroupA" = {
    ...
    managed_policies = ["S8_AMP_PolicyC"]
  }
}
...
roles = {
  "S8_RoleA" = {
    ...
    managed_policies = ["S8_AMP_PolicyD"]
  }
  "S8_RoleB" = {
    assume_users    = []
  ...
  "S8_RoleC" = {
    ...
    managed_policies = ["S8_AMP_PolicyF"]
  }
  "S8_RoleD" = {
    assume_users    = []
    ...
    managed_policies = ["S8_AMP_PolicyG"]
  }
}
